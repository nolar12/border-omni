    ...
    <div data-theme="light" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          ...
          {error && (
            <div className="flex items-center gap-2 bg-red-50 text-red-600 text-base rounded-lg px-3 py-2 mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="email" placeholder="seu@email.com"
                className="w-full border border-gray-200 rounded-xl px-3 py-3 text-base text-gray-900 bg-white outline-none focus:border-blue-400 transition-colors"
