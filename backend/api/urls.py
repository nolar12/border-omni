...
from apps.advertising.views import (
    ...
    PublicAdClickTokenView, LeadCommercialEventView, OnyxDigestSummaryView,
)
...
urlpatterns = [
    ...
    path('advertising/onyx-digest-summary/', OnyxDigestSummaryView.as_view(), name='onyx_digest_summary'),
