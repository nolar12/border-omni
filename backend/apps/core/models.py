...
class UserProfile(models.Model):
    ...
    kennel_cbkc_code = models.CharField(max_length=30, blank=True, default='')
    kennel_fci_code = models.CharField(max_length=30, blank=True, default='')
    kennel_prefix = models.CharField(max_length=120, blank=True, default='')
    kennel_owner_name = models.CharField(max_length=200, blank=True, default='')
    kennel_address_line = models.CharField(max_length=255, blank=True, default='')
    kennel_neighborhood = models.CharField(max_length=120, blank=True, default='')
    kennel_city = models.CharField(max_length=120, blank=True, default='')
    kennel_state = models.CharField(max_length=2, blank=True, default='')
    kennel_zip_code = models.CharField(max_length=20, blank=True, default='')
    kennel_phone = models.CharField(max_length=30, blank=True, default='')
    kennel_breed = models.CharField(max_length=120, blank=True, default='')
    kennel_registry_date = models.DateField(null=True, blank=True)
    kennel_issue_date = models.DateField(null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
